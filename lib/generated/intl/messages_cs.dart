...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "${count} ingredience(í)";

  static String m44(count) => "Vybráno: ${count}";

  static String m45(hour) => "${hour}:00";

  static String m46(hour, minute) => "${hour}:${minute}";

  static String m47(time) => "Čas připomínky: ${time}";

  static String m48(current, goal) => "${current} / ${goal} ml";

  static String m49(rate) => "${rate} kg/týden";

  static String m50(rate) => "${rate} lbs/týden";

  static String m51(age) => "${age} let";
