...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "${count} malzeme";

  static String m44(count) => "${count} seçildi";

  static String m45(hour) => "${hour}:00";

  static String m46(hour, minute) => "${hour}:${minute}";

  static String m47(time) => "Hatırlatma zamanı: ${time}";

  static String m48(current, goal) => "${current} / ${goal} ml";

  static String m49(rate) => "${rate} kg/hafta";

  static String m50(rate) => "${rate} lbs/hafta";

  static String m51(age) => "${age} yıl";
