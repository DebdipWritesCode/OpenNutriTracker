...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "${count} składnik(ów)";

  static String m44(count) => "Wybrano: ${count}";

  static String m45(hour) => "${hour}:00";

  static String m46(hour, minute) => "${hour}:${minute}";

  static String m47(time) => "Czas przypomnienia: ${time}";

  static String m48(current, goal) => "${current} / ${goal} ml";

  static String m49(rate) => "${rate} kg/tydzień";

  static String m50(rate) => "${rate} lbs/tydzień";

  static String m51(age) => "${age} lat";
